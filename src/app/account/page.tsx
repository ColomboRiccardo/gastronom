        ...
        <Tabs defaultValue="profile" className="w-full">
          <div className="overflow-x-auto -mx-4 px-4">
            <TabsList className="w-auto bg-secondary/50 border border-border mb-8 flex-wrap h-auto gap-1 p-1">
              {/* User tabs */}
              <TabsTrigger value="profile" className="font-body data-[state=active]:bg-primary data-[state=active]:text-primary-foreground gap-2 text-sm">
                <User className="w-4 h-4" />
                Profile
              </TabsTrigger>
              <TabsTrigger value="orders" className="font-body data-[state=active]:bg-primary data-[state=active]:text-primary-foreground gap-2 text-sm">
                <Package className="w-4 h-4" />
                Orders
              </TabsTrigger>
              <TabsTrigger value="settings" className="font-body data-[state=active]:bg-primary data-[state=active]:text-primary-foreground gap-2 text-sm">
                <Settings className="w-4 h-4" />
                Settings
              </TabsTrigger>
              <TabsTrigger value="wishlist" className="font-body data-[state=active]:bg-primary data-[state=active]:text-primary-foreground gap-2 text-sm">
              ...
              {mockAdminConfig.isAdmin && (
                <>
                  ...
                  <TabsTrigger value="admin-orders" className="font-body data-[state=active]:bg-[hsl(var(--navy))] data-[state=active]:text-primary-foreground gap-2 text-sm">
                    <ClipboardList className="w-4 h-4" />
                    All Orders
                  </TabsTrigger>
                  <TabsTrigger value="admin-products" className="font-body data-[state=active]:bg-[hsl(var(--navy))] data-[state=active]:text-primary-foreground gap-2 text-sm">
                    <ShoppingBag className="w-4 h-4" />
                    Products
                  </TabsTrigger>
                  <TabsTrigger value="admin-customers" className="font-body data-[state=active]:bg-[hsl(var(--navy))] data-[state=active]:text-primary-foreground gap-2 text-sm">
